        ...
        <div class="container">
            <div class="row">
                <div class="col-md-3 col-xs-2">
                    <div id="fh5co-logo"><a href="/mvc">Shop.</a></div>
                </div>
                <div class="col-md-6 col-xs-6 text-center menu-1">
                    <ul>
                        ...
                        <li><a href="/mvc/contact">Contact</a></li>
                    </ul>
                </div>
                    ...
                    <div class="owl-carousel owl-carousel-fullwidth product-carousel">
                        <div class="item">
                            <div class="active text-center">
                                <figure>
                                    <img src="../../shop/images/product-single-1.jpg" alt="user">
                                </figure>
                            </div>
                        </div>
                        <div class="item">
                            <div class="active text-center">
                                <figure>
                                    <img src="../../shop/images/product-single-2.jpg" alt="user">
                                </figure>
                            </div>
                        </div>
                        <div class="item">
                            <div class="active text-center">
                                <figure>
                                    <img src="../../shop/images/product-single-3.jpg" alt="user">
                                </figure>
                            </div>
                        </div>
                        <div class="item">
                            <div class="active text-center">
                                <figure>
                                    <img src="../../shop/images/product-single-4.jpg" alt="user">
                                </figure>
                            </div>
                        </div>
                        <div class="item">
                            <div class="active text-center">
                                <figure>
                                    <img src="../../shop/images/product-single-5.jpg" alt="user">
                                </figure>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="fh5co-tabs animate-box">
                        ...
                        <div class="fh5co-tab-content-wrap">
                            ...
                            <div class="fh5co-tab-content tab-content active" data-tab-content="1">
                                <div class="col-md-10 col-md-offset-1">
                                    <span class="price">${select_item.getPrice()}</span>
                                    <h2>${select_item.getName()}</h2>
                                    <p>${select_item.getContent()}</p>
